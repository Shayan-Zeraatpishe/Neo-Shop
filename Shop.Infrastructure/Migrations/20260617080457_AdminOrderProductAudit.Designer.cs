...
namespace Shop.Infrastructure.Migrations
{
    ...
    [Migration("20260617080457_AdminOrderProductAudit")]
    partial class AdminOrderProductAudit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shop.Domain.Entities.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shop.Domain.Entities.DownloadToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shop.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<string>("DigitalFileOriginalName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SeoCanonicalUrl")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Shop.Domain.Entities.DownloadToken", b =>
                {
                    b.HasOne("Shop.Domain.Entities.OrderItem", "OrderItem")
                        .WithOne("DownloadToken")
                        .HasForeignKey("Shop.Domain.Entities.DownloadToken", "OrderItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
